...
import "./App.css";
import Gallery from "./Componenetes/Gallery/Gallery";
import Preguntas from "./Componenetes/Preguntas/Preguntas";
...
function App() {
  return (
    <div>
      <Gallery personas={persons}></Gallery>
      <Preguntas pregunt={questionsType}></Preguntas>
    </div>
  );
}
